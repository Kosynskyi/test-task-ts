...
const UserNav = () => {
    ...
    return (<material_1.Box>
      <material_1.List sx={{
        ...
        <UserNav_styled_1.StyledNavLink to="/" end>
        ...
        <UserNav_styled_1.StyledNavLink to="/news">
          <material_1.IconButton aria-label="home" size="large" sx={{ padding: 0, marginLeft: 2, color: 'blue' }}>
            <Newspaper_1.default fontSize="inherit"/>
          </material_1.IconButton>
        </UserNav_styled_1.StyledNavLink>
        {isLoggedIn && (<UserNav_styled_1.StyledNavLink to="/profile">
